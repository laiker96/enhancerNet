...
def main():
    ...
    parser.add_argument("output_file", type=str, help="Output .npy file with predictions")
    ...
    os.system(f"python one_hot.py --fasta {args.fasta_file} --output temp_input.npy")
    ...
    # Step 3: Load model
    # Adjust parameters according to your training setup
